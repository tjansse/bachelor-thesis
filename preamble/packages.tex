...
\DeclareSourcemap{
  \maps[datatype=bibtex, overwrite]{
    ...
    \map{
	  ...
	  \step[fieldset=doi, null] % only show doi when there is no eprint
...
% Allow/Prevent line breaks at hyphen/dash.
% Normally LaTeX won't hyphenate words that have a dash in it.
% With the shortcuts option, this package introduces the commands \-/ and \=/
