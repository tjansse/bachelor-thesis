...
\begin{figure}[]
	...
	\caption{The transverse momentum $p_\perp$ of the Higgs boson differential in the momentum fraction x of one of the gluons.}
...
\begin{figure}[]
	...
	\caption{The rapidity $y$ of the Higgs boson differential in the momentum fraction x of one of the gluons.}
